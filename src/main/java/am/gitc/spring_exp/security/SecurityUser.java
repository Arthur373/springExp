...
import am.gitc.spring_exp.entity.Status;
...
public class SecurityUser implements UserDetails {
    ...
    public static UserDetails fromUser(UserModel userModel) {
        return new User(userModel.getEmail(), userModel.getPassword(),
                userModel.getStatus().equals(Status.ACTIVE),
                userModel.getStatus().equals(Status.ACTIVE),
                userModel.getStatus().equals(Status.ACTIVE),
                userModel.getStatus().equals(Status.ACTIVE),
                userModel.getRole().getAuthorities()
        );
    }
}
